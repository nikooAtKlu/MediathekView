...
public class MVConfig {
    ...
    public enum Configs {
        ...
        SYSTEM_PARAMETER_IGNORE_SPECIFIC_SSL_HOSTS("__system-parameter__ignore_specific_ssl_hosts__", Boolean.FALSE.toString()),//ignoriere manche hosts bei SSL-Check
