...
public class MVConfig {
    ...
    public enum Configs {
        ...
        SYSTEM_PARAMETER_USERAGENT("__system-parameter__useragent_" + Functions.getProgVersion().toString() + "__", Konstanten.USER_AGENT_DEFAULT),//Useragent für direkte Downloads
